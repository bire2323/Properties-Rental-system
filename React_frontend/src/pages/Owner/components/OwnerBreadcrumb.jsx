...
export default function OwnerBreadcrumb() {
    ...
    return (
        <div className="rounded-3xl border border-slate-50  px-4 py-3 text-sm text-slate-600 shadow-sm dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300">
