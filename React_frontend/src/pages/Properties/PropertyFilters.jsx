...
import { Building2, Search, SlidersHorizontal, ChevronDown } from 'lucide-react'
                ...
                <div className="space-y-3 lg:hidden">
                    <div className="relative">
                        ...
                        <Input
                            ...
                            value={searchTerm}
                            onChange={(e) => setSearchTerm(e.target.value)}
                            className="h-12 w-full rounded-xl border-slate-300 pl-10 pr-4 shadow-sm dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                        />
                    </div>
