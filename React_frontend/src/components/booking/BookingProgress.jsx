          ...
          return (
            <li key={step.id} className="flex flex-1 items-center sm:flex-none sm:min-w-[9rem]">
              <div className="flex min-w-0 flex-1 flex-col items-center gap-2 sm:items-start">
                <div className="flex items-center gap-2">
                  <motion.div
                    ...
                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border text-xs font-semibold transition-colors ${isComplete || isActive
                  ...
                  <span
                    className={`hidden text-sm font-medium sm:inline ${isActive
                ...
                <span
                  className={`text-[11px] font-medium sm:hidden ${isActive ? 'text-slate-900 dark:text-white' : 'text-slate-500 dark:text-slate-400'
                    }`}
                >
                  {step.label}
                </span>
              ...
              {index < STEPS.length - 1 && (
                <div
                  className={`mx-2 hidden h-px flex-1 sm:block ${currentStep > step.id ? 'bg-[#c99b43]' : 'bg-slate-200 dark:bg-slate-700'
                    }`}
                />
              )}
            </li>
